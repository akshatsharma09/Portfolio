  ...
  return (
    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
        <motion.h1
          className="text-4xl md:text-6xl font-black bg-gradient-to-r from-primary-600 via-accent-600 to-primary-800 bg-clip-text text-transparent animate-float"
        ...
        <motion.p
          className="mt-6 text-xl md:text-2xl text-secondary-800 font-medium"
      ...
      <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.4, duration: 0.6 }} className="flex justify-center">
        <div className="w-72 h-72 rounded-2xl bg-white shadow-2xl flex items-center justify-center overflow-hidden border border-secondary-200">
